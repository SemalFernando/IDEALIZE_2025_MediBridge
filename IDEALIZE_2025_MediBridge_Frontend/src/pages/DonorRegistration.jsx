      ...
      <div className={styles.authFormContainer}>
        <div className={styles.authForm}>
          ...
          <div className={styles.socialButtons}>
            <button type="button" className={styles.socialButton} onClick={() => alert('GitHub login coming soon')}>
              <FaGithub className={styles.socialIcon} />
              GitHub
            </button>
            <button type="button" className={styles.socialButton} onClick={() => alert('Google login coming soon')}>
              <img src="/images/google-icon.svg" alt="Google" className={styles.socialIcon} />
              Google
            </button>
          </div>

          <div className={styles.authFooter}>
            Already have an account? <Link to="/donor-login" className={styles.authLink}>Sign in</Link>
          </div>
        </div>
      </div>
    </div>
